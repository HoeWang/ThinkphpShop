...
<html>
	...
	<head>
		...
		<link href="/Test/Public/css/stepstyle.css" rel="stylesheet" type="text/css">
		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<form class="am-form am-form-horizontal" method="post" action="<?php echo U('User/changePass');?>" id="keep">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="password" id="user-new-password" placeholder="由数字、字母组合" name="pwd">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">确认密码</label>
							<div class="am-form-content">
								<input type="password" id="user-confirm-password" placeholder="请再次输入上面的密码" name="pwd2">
							</div>
						</div>
						<div class="info-btn">
							<a href="javascript:document.getElementById('keep').submit();"><div class="am-btn am-btn-danger">保存修改</div></a>
						</div>
