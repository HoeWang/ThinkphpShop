...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="/Test/Public/Admin/assets/css/bootstrap.min.css" rel="stylesheet" />
		...
		<script src="/Test/Public/Admin/js/displayPart.js" type="text/javascript"></script>
 ...
 <div class="Feedback_style">
  ...
  <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
     <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
          ...
          <a href="javascript:;" onclick="Guestbook_iew('<?php echo ($v["username"]); ?>','<?php echo ($v["text"]); ?>')"><?php echo ($v["text"]); ?></a>
 ...
 <div class="content_style">
  <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">留言用户 </label>
   ...
   <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 留言内容 </label>
       <div class="col-sm-9 utext">三年同窗，一起沐浴了一片金色的阳光，一起度过了一千个日夜，我们共同谱写了多少友谊的篇章?愿逝去的那些闪亮的日子，都化作美好的记忆，永远留在心房。认识您，不论是生命中的一段插曲，还是永久的知已，我都会珍惜，当我疲倦或老去，不再拥有青春的时候，这段旋律会滋润我生命的每一刻。在此我只想说：有您真好!无论你身在何方，我的祝福永远在您身边!</div>
	</div>
...
/*留言查看*/
function Guestbook_iew(name,text){
  $('.uname').html(name);
  $('.utext').html(text);
  
  Guestbook_iew1(name,text);
};
function Guestbook_iew1(name,text){
