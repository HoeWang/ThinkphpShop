...
<div class="margin clearfix">
    <div class="border clearfix">
        <span class="l_f">
	        <a href="<?php echo U('Admin/node');?>" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i> 添加权限</a>
    ...
    <div class="compete_list">
       	<table id="sample-table-1" class="table table-striped table-bordered table-hover">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
					...
					<td><?php echo ($v['urls']); ?></td>
					<td><?php echo ($v['title']); ?></td>
					<td>
	                 <a title="编辑" href="<?php echo U('Admin/node', ['id'=>$v['id']]);?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>        
	                 <a title="删除" href="javascript:;"  onclick="del(this, <?php echo ($v['id']); ?>)" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
					</td>
...
<script>
	$(function(){
		$("#sample-table-1 thead tr th input:checkbox").click(function(){
...
// 		window.location.href = "<?php echo U('Admin/node', ['id'=>id]);?>";
// 		window.location.href ="node.html?="+id;
// };	
/*字数限制*/
