...
<meta http-equiv="Cache-Control" content="no-siteapp" />
        ...
        <link rel="stylesheet" href="/Test/Public/Admin/assets/css/colorbox.css"> 
         <!--图片相册-->   
        ...
        <script src="/Test/Public/Admin/assets/js/jquery.colorbox-min.js"></script>
...
<div class="page-content clearfix">
 ...
 <!--列表样式-->
	...
	<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
       ...
       <td><span class="ad_img"><a href="/Test/Public/Admin/products/ad.jpg" data-rel="colorbox" data-title="广告图"><img src="/Test/Public/Uploads/<?php echo ($v["ad_code"]); ?>"  width="100%" height="100%"/></a></span></td>      
       <td><a href="" target="_blank"><?php echo ($v["ad_link"]); ?></a></td>
       <td><?php echo ($v["addtime"]); ?></td>
       
      <?php if($v['status'] == '显示'): ?><td class="td-status"><span class="label label-success radius"><?php echo ($v['status']); ?></span></td>
	  <td class="td-manage">
		...
		<a title="编辑" href="<?php echo U('Advertising/edit?id='.$v['id']);?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
	   ...
	   <?php else: ?>
	   <td class="td-status"><span class="label label-defaunt radius"><?php echo ($v['status']); ?></span></td>
	  <td class="td-manage">
		<a style="text-decoration:none" class="btn btn-xs " onclick="member_start(this,'<?php echo ($v['id']); ?>')" href="javascript:;" title="显示"><i class="fa fa-close bigger-120"></i></a>   
		<a title="编辑" href="<?php echo U('Advertising/edit?id='.$v['id']);?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
		<a title="删除" href="javascript:;"  onclick="member_del(this,'<?php echo ($v['id']); ?>')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
		</td><?php endif; ?>
