...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="/Test/Public/Admin/assets/css/bootstrap.min.css" rel="stylesheet" />
		...
		<script type="text/javascript" src="/Test/Public/Admin/Widget/swfupload/swfupload.js"></script>
		<script type="text/javascript" src="/Test/Public/Admin/Widget/swfupload/swfupload.queue.js"></script>
		<script type="text/javascript" src="/Test/Public/Admin/Widget/swfupload/swfupload.speed.js"></script>
		<script type="text/javascript" src="/Test/Public/Admin/Widget/swfupload/handlers.js"></script>
<title>广告管理</title>
</head>
...
<div class=" clearfix" id="advertising">
	<div id="scrollsidebar" class="left_Treeview">
		    	...
		    	<div class="widget-header header-color-green2">
		  		...
		  		<div class="widget-body">
			 		<ul class="b_P_Sort_list">
				 		...
				 		<?php if(is_array($tidc)): foreach($tidc as $key=>$v): ?><li><i class="fa fa-image pink "></i> <a href="<?php echo U('Advertising/ads_list','tid='.$v['tid']);?>"><?php echo ($v["tname"]); ?>(<?php echo ($v["count(*)"]); ?>)</a></li><?php endforeach; endif; ?>
			 		</ul>
	  			</div>
	  		</div>
	  	</div>  
  	...
  	<div class="Ads_list">
	   ...
	   <span class="l_f"><!---->
		<a href="<?php echo U('Advertising/upload');?>" id="" class="btn btn-warning"><i class="fa fa-plus"></i> 添加广告</a>
		<a href="javascript:void(0)" class="btn btn-danger" id="pdel"><i class="fa fa-trash"></i> 批量删除</a>
	   </span>
	...
	<tbody>
	  ...
	  <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr>
	   ...
	   <td><span class="ad_img"><img src="/Test/Public/Uploads/<?php echo ($val["ad_code"]); ?>"  width="100%" height="100%"/></span></td>
	   <td><a href="/Test/Public/Admin/#" target="_blank"><?php echo ($val['ad_link']); ?></a></td>
	   <td><?php echo ($val['addtime']); ?></td>
	   <?php if($val['status'] == '显示'): ?><td class="td-status"><span class="label label-success radius"><?php echo ($val['status']); ?></span></td>
	  <td class="td-manage">
		<a onclick="member_stop(this,'<?php echo ($val['id']); ?>')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>   
		<a title="编辑" href="<?php echo U('Advertising/edit?id='.$val['id']);?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
		<a title="删除" href="javascript:;"  onclick="member_del(this,'<?php echo ($val['id']); ?>')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
	   </td>
	   <?php else: ?>
	   <td class="td-status"><span class="label label-defaunt radius"><?php echo ($val['status']); ?></span></td>
	  <td class="td-manage">
		<a style="text-decoration:none" class="btn btn-xs " onclick="member_start(this,'<?php echo ($val['id']); ?>')" href="javascript:;" title="显示"><i class="fa fa-close bigger-120"></i></a>   
		<a title="编辑" href="<?php echo U('Advertising/edit?id='.$val['id']);?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
		<a title="删除" href="javascript:;"  onclick="member_del(this,'<?php echo ($val['id']); ?>')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
		</td><?php endif; ?>
...
<div id="add_ads_style"  style="display:none">
 ...
 <div class="demo">
			   <div class="logobox"><div class="resizebox"><img src="/Test/Public/Admin/images/image.png" width="100px" alt="" height="100px"/></div></div>	
			   <div class="logoupload">
				  <div class="btnbox"><a id="uploadBtnHolder" class="uploadbtn" href="javascript:;">上传提交</a></div>
...
function member_stop(obj,id){
	layer.confirm('确认要关闭吗？',{icon:0,},function(index){
		...
		$.post("/Test/Admin/Advertising/handle",{id:id,mark:1},function(data){
			if(data > 0){
...
function member_start(obj,id){
	layer.confirm('确认要显示吗？',{icon:0,},function(index){
		...
		$.post("/Test/Admin/Advertising/handle",{id:id,mark:2},function(data){
			if(data > 0){
...
function member_del(obj,id){
	...
	layer.confirm('确认要删除'+id+'吗？',{icon:0,},function(index){
		$.post("/Test/Admin/Advertising/handle",{id:id,mark:3},function(data){
			if(data > 0){
...
$('#pdel').click(function(){
	...
	var checkId = $('#sample-table tr td input[type="checkbox"]:checked').map(function() {
			// 获取ID
	...
	if (checkId !== '') {
		layer.confirm('确认要删除'+checkId+'吗？',{icon:0,},function(index){
		$.post("/Test/Admin/Advertising/handle",{check_id:checkId,mark:'del_all'},function(data){
			console.log(data);
			if(data > 0){
				$('#sample-table tr td input[type="checkbox"]:checked').parent().parent().remove();
...
$(document).ready(function() {
	var settings = {
		flash_url : "/Test/Public/Admin/Widget/swfupload/swfupload.swf",
		flash9_url : "/Test/Public/Admin/Widget/swfupload/swfupload_fp9.swf",
		upload_url: "/Test/Admin/Advertising_/handle",// 接受上传的地址
		...
		debug: false,
		// Button settings
		button_image_url: "/Test/Public/Admin/Widget/swfupload/upload-btn.png",
		button_width: "95",
		button_height: "30 ",
