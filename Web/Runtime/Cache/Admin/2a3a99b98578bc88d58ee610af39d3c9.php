     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             <li><i class="orange  fa fa-user-secret"></i><a href="/Test/Public/Admin/#">全部(235)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="/Test/Public/Admin/#">普通会员(235)</a></li>
             <li> <i class="fa fa-diamond pink "></i> <a href="/Test/Public/Admin/#">铁牌会员(2215)</a> </li>
             <li> <i class="fa fa-diamond pink "></i> <a href="/Test/Public/Admin/#">铜牌会员(3456)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="/Test/Public/Admin/#">银牌会员(4332)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="/Test/Public/Admin/#">金牌会员(1332)</a></li>
             <li> <i class="fa fa-diamond grey"></i> <a href="/Test/Public/Admin/#">钻石会员(4543)</a></li>
             <li> <i class="fa fa-diamond red"></i> <a href="/Test/Public/Admin/#">红钻会员(343)</a></li>
             <li> <i class="fa fa-diamond blue"></i> <a href="/Test/Public/Admin/#">蓝钻会员(2343)</a></li>
             <li> <i class="fa fa-diamond grey"></i> <a href="/Test/Public/Admin/#">黑钻2(53)</a></li>
            </ul>
  </div>
  </div>
  </div>  --> 
 <!--  </div> -->
  <!--右侧样式-->
   ...
   <!-- <div class="Statistics_style" id="Statistic_pie">
	...
	<tbody>
		<tr>
    <?php if(is_array($list)): foreach($list as $key=>$v): ?><td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
          <td><?php echo ($v["id"]); ?></td>
          ...
          <td>普通用户</td>
          <td class="text-l"><?php echo ($v["sign"]); ?></td>
...
function member_stop(obj,id){
	layer.confirm('确认要停用吗？',function(index){
		$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" class="btn btn-xs " onClick="member_start(this,id)" href="/Test/Public/Admin/javascript:;" title="启用"><i class="fa fa-close bigger-120"></i></a>');
...
function member_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" class="btn btn-xs btn-success" onClick="member_stop(this,id)" href="/Test/Public/Admin/javascript:;" title="停用"><i class="fa fa-check  bigger-120"></i></a>');
