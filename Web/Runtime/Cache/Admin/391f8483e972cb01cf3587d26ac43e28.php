...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/Test/Public/Admin/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="/Test/Public/Admin/assets/css/ace-skins.min.css" />
        <link rel="stylesheet" href="/Test/Public/Admin/css/style.css"/>
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="assets/css/ace-ie.min.css" />
		<![endif]-->
		<script src="/Test/Public/Admin/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='/Test/Public/Admin/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
		...
		<![endif]-->
		<script src="/Test/Public/Admin/assets/js/ace-elements.min.js"></script>
		<script src="/Test/Public/Admin/assets/js/ace.min.js"></script>
        ...
        <script src="/Test/Public/Admin/js/jquery.nicescroll.js" type="text/javascript"></script>
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
                       <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="<?php echo U('Goods/productsList');?>"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
                         <li class="home"><a  href="javascript:void(0)" name="<?php echo U('Brand/brandList');?>" title="品牌管理"  class="iframeurl"><i class="icon-double-angle-right"></i>品牌管理</a></li>
                         <li class="home"><a href="javascript:void(0)" name="<?php echo U('Goods/index');?>" title="分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>分类管理</a></li>
					...
					<a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 图片管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
						<li class="home"><a href="javascript:void(0)" name="<?php echo U('Advertising/index');?>" title="广告管理" class="iframeurl"><i class="icon-double-angle-right"></i>广告管理</a></li>
						<!-- <li class="home"><a href="javascript:void(0)" name="<?php echo U('Advertising/sort_ads');?>" title="分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>分类管理</a></li> -->
						<li class="home"><a href="javascript:void(0)" name="<?php echo U('Advertising/seo');?>" title="SEO管理"  class="iframeurl"><i class="icon-double-angle-right"></i>SEO管理</a></li>
							</ul>
						</li>
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 交易管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                    <li class="home"><a href="javascript:void(0)" name="<?php echo U('Order/detail');?>" title="交易信息"  class="iframeurl"><i class="icon-double-angle-right"></i>交易信息</a></li>
                    ...
                    <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Order/OrderForm');?>" title="订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
           ...
           <!--         <li>
                  ...
                  <li>
                    ...
                    <li class="home"><a href="javascript:void(0)" name="<?php echo U('User/sign');?>" title="等级管理"  class="iframeurl"><i class="icon-double-angle-right"></i>等级管理</a></li>
			...
			<!-- 	  <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 店铺管理 </span><b class="arrow icon-angle-down"></b></a>
						...
						<li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text"> 消息管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
                                ...
                                <li class="home"><a href="javascript:void(0)" name="<?php echo U('Feedback/index');?>" title="意见反馈" class="iframeurl"><i class="icon-double-angle-right"></i>意见反馈</a></li>
							</ul>
						</li>
						<!-- <li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 文章管理 </span><b class="arrow icon-angle-down"></b></a>
                        	...
                        	<li><a href="#" class="dropdown-toggle"><i class="icon-cogs"></i><span class="menu-text"> 促销管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="<?php echo U('Cuxiao/index');?>" title="系统设置" class="iframeurl"><i class="icon-double-angle-right"></i>促销设置</a></li>
 ...
 -->							</ul>
						...
						<?php if($_SESSION['adminInfo']['name'] == 'admin'): ?><li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
							
								<li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/index');?>" title="角色管理"  class="iframeurl"><i class="icon-double-angle-right"></i>角色管理</a></li>
                                <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/showList');?>" title="管理员列表" class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
                                <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/powers');?>" title="权限管理" class="iframeurl"><i class="icon-double-angle-right"></i>权限管理</a></li>
								  <!-- <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/info');?>" title="管理员日志" class="iframeurl"><i class="icon-double-angle-right"></i>管理员日志</a></li> -->
							</ul>
						</li><?php endif; ?>
					</ul>
					</div>
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="<?php echo U('Home/index');?>">  </iframe>
